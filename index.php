    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 m6">
                ...
                <p class="animated slideInUp wow">This is a E-Commerce website developed for academic purpose.This web application is developed for continues
                assesment of Secure Programming for Web. We have tried include as much as security features in this project and tried to make this application secured</p>
            </div>
    ...
    <div class="row">
        <form action="https://postmail.invotes.com/send" method="post" id="email_form" class="col s12 animated slideInUp wow">
            ...
            <div class="row">
                ...
                <input type="hidden" name="access_token" value="kke3mu4tpyquhzlv11egp7do" />
